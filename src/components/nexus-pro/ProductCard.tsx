...
export const PRODUCTS: ProductData[] = [
  ...
  {
    id         : 'wild-berry',
    edition    : 'Wild Berry Tea',
    tagline    : 'Vibrant · Antioxidant · Refreshing',
    category   : 'Berry Blend',
    description: 'A bold fusion of wild strawberry, blueberry, blackberry and raspberry with crisp green tea. Vibrant and rejuvenating.',
    price      : '$45',
    accentHex  : '#a06abf',
    glowRgba   : 'rgba(160,106,191,0.22)',
    imageSrc   : '/products/tea-wild-berry.png',
  },
  {
    id         : 'matcha',
    edition    : 'Matcha Green Tea',
    tagline    : 'Pure · Energizing · Focused',
    category   : 'Matcha',
    description: 'Ceremonial-grade Japanese matcha stone-ground to silk. Rich in L-theanine — calm energy, enhanced focus.',
    price      : '$58',
    accentHex  : '#6aaa3c',
    glowRgba   : 'rgba(90,160,50,0.22)',
    imageSrc   : '/products/tea-matcha.png',
  },
  {
    id         : 'hibiscus',
    edition    : 'Hibiscus Green Tea',
    tagline    : 'Tangy · Floral · Refreshing',
    category   : 'Hibiscus Blend',
    description: 'Sun-dried hibiscus petals with premium green tea. Deep crimson, tangy-floral. Supports digestion and immunity.',
    price      : '$44',
    accentHex  : '#c04050',
    glowRgba   : 'rgba(192,64,80,0.22)',
    imageSrc   : '/products/tea-hibiscus.png',
  },
]
