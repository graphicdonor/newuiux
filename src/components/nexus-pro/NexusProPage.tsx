...
export default function NexusProPage() {
  ...
  useEffect(() => {
    ...
    const gsapCtx = gsap.context(() => {
      ...
      stTl
        .fromTo(storyHeadRef.current,  { opacity:0, y:48 }, { opacity:1, y:0, duration:0.75, ease:'power3.out' }, 0)
        .fromTo(storyCol1Ref.current,  { opacity:0, y:32 }, { opacity:1, y:0, duration:0.65, ease:'power2.out' }, 0.22)
        .fromTo(storyCol2Ref.current,  { opacity:0, y:32 }, { opacity:1, y:0, duration:0.65, ease:'power2.out' }, 0.35)
